...
if os.path.exists(TRAIN_PREPARED_PATH) and os.path.exists(VALIDATION_PREPARED_PATH):
    ...
    x_train, y_train = data_preparation.get_percentage_of_data(x_train, y_train, 0.03, shuffle=False)
    x_validation, y_validation = data_preparation.get_percentage_of_data(x_validation, y_validation, 0.03, shuffle=False)
